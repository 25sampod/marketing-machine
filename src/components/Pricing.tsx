   ...
   <div className="mx-auto max-w-6xl px-4 sm:px-6">
    ...
    <div className="mb-10 sm:mb-12 flex items-center justify-center gap-2 sm:gap-4 flex-wrap">
     ...
     >
      ...
      <span className="px-2 py-0.5 rounded-full text-[10px] sm:text-[11px] font-semibold bg-[var(--amber)]/15 text-[var(--amber-deep)] border border-[var(--amber)]/30">
       Save ~17%
      </span>
     </button>
    </div>
       ...
       >
        {isPopular && (
         <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 pointer-events-none">
          <span className="px-3 sm:px-3.5 py-1 rounded-full text-[10px] sm:text-[11px] font-bold uppercase tracking-wider bg-[var(--amber)] text-[var(--text-on-amber)] shadow-xs whitespace-nowrap">
        ...
        <div>
         ...
         <p className="text-xs font-semibold uppercase tracking-wider text-[var(--ink)]/50 mb-4 font-semibold">
          What&apos;s included
         </p>
    ...
    <div className="mt-12 sm:mt-16 pt-8 sm:pt-10 border-t border-[var(--paper-line)] grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4 lg:gap-6 text-center min-w-0">
     <div className="p-3 sm:p-4 rounded-xl bg-[var(--paper-raised)]/40 border border-[var(--paper-line)]/70 hover:bg-[var(--paper-raised)]/70 transition-colors min-w-0">
      <span className="text-xs font-bold text-[var(--ink)] uppercase tracking-wider block mb-1">
       SOC 2 Type II
      </span>
     ...
     <div className="p-3 sm:p-4 rounded-xl bg-[var(--paper-raised)]/40 border border-[var(--paper-line)]/70 hover:bg-[var(--paper-raised)]/70 transition-colors min-w-0">
      <span className="text-xs font-bold text-[var(--amber-deep)] uppercase tracking-wider block mb-1">
       Zero Vendor Lock-In
      </span>
      <span className="text-[11px] sm:text-xs text-[var(--ink)]/60 leading-relaxed">
