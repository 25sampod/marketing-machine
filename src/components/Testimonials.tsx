  ...
  >
   <div className="mx-auto max-w-6xl px-4 sm:px-6">
    ...
    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-8 sm:mb-12">
     <div>
      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--paper-raised)] border border-[var(--paper-line)] text-xs font-medium text-[var(--amber-deep)] mb-3 sm:mb-4">
       <span>★ 4.9/5</span>
     ...
     <div className="flex items-center gap-3 self-end sm:self-auto">
      ...
      <span className="text-xs text-[var(--ink)]/50 px-1">
        ...
        <figure className="bg-[var(--paper-raised)] border border-[var(--paper-line)] p-4 sm:p-8 md:p-14 flex flex-col justify-between min-h-[280px] sm:min-h-[320px] rounded-xl sm:rounded-2xl relative overflow-hidden shadow-sm">
         ...
         <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-3 pb-4 sm:pb-6 mb-4 sm:mb-6 border-b border-[var(--paper-line)] relative z-10">
          <div className="flex items-center gap-2.5 sm:gap-3">
           <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[var(--paper)] border border-[var(--paper-line)] text-xs font-bold text-[var(--amber-deep)] flex items-center justify-center">
            {t.companyBadge}
           </span>
          ...
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-[var(--amber)]/10 border border-[var(--amber)]/20 text-xs font-medium text-[var(--amber-deep)]">
         ...
         <figcaption className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-[var(--paper-line)] flex items-center justify-between gap-3 relative z-10">
          <div className="flex items-center gap-2.5 sm:gap-3">
           <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[var(--paper)] border border-[var(--paper-line)] text-xs font-medium text-[var(--ink)] flex items-center justify-center shrink-0">
          ...
          <span className="inline-flex items-center gap-1.5 text-[11px] sm:text-xs font-medium text-teal bg-teal/10 px-2 sm:px-2.5 py-1 rounded border border-teal/20 shrink-0">
