      ...
      <div className="h-full rounded-2xl border border-[var(--paper-line)] bg-[var(--paper-raised)] p-6 flex flex-col justify-between shadow-xs hover:border-[var(--amber)]/50 hover:-translate-y-1 hover:shadow-md transition-all duration-200 group">
       <div>
        ...
        <div className="flex items-center justify-between gap-3 mb-5">
         <span className="text-xs font-bold text-[var(--amber-deep)] bg-[var(--paper)] border border-[var(--paper-line)] px-2.5 py-1 rounded-lg shadow-2xs group-hover:border-[var(--amber)]/30 transition-colors">
          01
         </span>
       ...
       <div className="mt-6 pt-4 border-t border-[var(--paper-line)]">
        <p className="text-[11px] font-medium text-[var(--ink)]/50 uppercase tracking-wider mb-2 ">
         Supported apps
        </p>
        <div className="flex items-center gap-1.5 flex-wrap">
         ...
         {/* +200 more */}
         <span className="text-[11px] font-medium text-[var(--ink)]/55 px-1.5 py-0.5 rounded bg-[var(--paper)] border border-[var(--paper-line)]">
          +200
         </span>
        </div>
       </div>
