  ...
  >
   ...
   >
    ...
    <div className="p-6 space-y-4">
     ...
     {/* Divider */}
     <div className="flex items-center gap-2 text-[11px] font-semibold uppercase text-[var(--ink)]/40 my-1">
     ...
     <form onSubmit={handleSubmit} className="space-y-3">
      <div>
       <label className="text-[10px] font-semibold uppercase text-[var(--ink)]/60 block mb-1 font-semibold">
        Email Address
       </label>
       <div className="relative">
        ...
        <input
         ...
         className="w-full text-xs font-medium pl-9 pr-3 py-2.5 rounded-lg border border-[var(--paper-line)] bg-[var(--paper-raised)] text-[var(--ink)] focus:outline-none focus:border-[var(--amber)]"
        />
       </div>
      </div>
      ...
      <div>
       ...
       <div className="relative">
        ...
        <input
         ...
         className="w-full text-xs font-medium pl-9 pr-10 py-2.5 rounded-lg border border-[var(--paper-line)] bg-[var(--paper-raised)] text-[var(--ink)] focus:outline-none focus:border-[var(--amber)]"
        />
        <button
         type="button"
