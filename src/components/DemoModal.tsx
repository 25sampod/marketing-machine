    ...
    <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-[var(--paper-line)] bg-[var(--paper-raised)]">
     <div>
      <div className="flex items-center gap-2 mb-1">
       ...
       <span className="text-[11px] font-medium uppercase tracking-wider text-[var(--ink)]/60">
        Product Tour
       </span>
      </div>
      <h2
     ...
     >
      <span className="hidden sm:inline text-[10px] font-medium text-[var(--ink)]/40 bg-[var(--paper)] px-1.5 py-0.5 rounded border border-[var(--paper-line)]">
       ESC
      </span>
