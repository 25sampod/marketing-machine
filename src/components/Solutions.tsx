         ...
         >
          ...
          <div className="w-full min-w-0">
           ...
           <div className="mb-5 sm:mb-6">
            <span className="text-[11px] sm:text-xs text-[var(--ink)]/50 uppercase tracking-wider block mb-2">
          ...
          <div className="w-full min-w-0 rounded-xl border border-[var(--paper-line)] bg-[var(--paper)] dark:bg-[var(--paper-deep)] p-3.5 sm:p-5 md:p-6 shadow-2xs flex flex-col gap-3 sm:gap-4">
           <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-[var(--paper-line)]">
            <span className="text-[11px] sm:text-xs font-semibold text-[var(--ink)]/75 uppercase tracking-wider ">
            ...
            {sol.workflows.map((wf, i) => (
             ...
             >
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
               <span className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-[var(--amber)]/15 text-[var(--amber-deep)] text-[10px] font-medium sm:text-xs font-semibold flex items-center justify-center shrink-0">
                {i + 1}
               </span>
              ...
              <span className="text-[10px] font-medium sm:text-[11px] text-[var(--ink)]/55 px-2 py-0.5 rounded bg-[var(--paper)] dark:bg-[var(--paper-deep)] border border-[var(--paper-line)] shrink-0 font-medium">
               {wf.time}
              </span>
             </div>
            ))}
